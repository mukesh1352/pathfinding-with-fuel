...
class Graph:
    ...
    def a_star(self, start, end):
        ...
        priority_queue = [(0, start, self.fuel_capacity)]  # (total_cost, current_node, remaining_fuel)
        visited = set()
        cost_so_far = {start: 0}
            ...
            for neighbor in self.graph.neighbors(current_node):
                ...
                if remaining_fuel >= fuel_needed:
                    ...
                    if neighbor not in cost_so_far or new_cost < cost_so_far[neighbor]:
                        ...
                        heapq.heappush(priority_queue, (new_cost + self.heuristic(neighbor, end), neighbor, remaining_fuel - fuel_needed))
...
edges = [
    ('A', 'B', 30), ('A', 'I', 56), ('B', 'C', 2), ('B', 'F', 14),
    ('C', 'D', 30), ('C', 'I', 4), ('D', 'E', 4), ('D', 'F', 5),
    ('D', 'G_Bunk', 20), ('E', 'H_Bunk', 22), ('E', 'K', 3),
    ('F', 'G_Bunk', 33), ('G_Bunk', 'H_Bunk', 42), ('H_Bunk', 'K', 5),
    ('I', 'J', 6), ('J', 'E', 3), ('J', 'K', 4)
]
...
def index():
    ...
    return render_template('index.html', nodes=g.graph.nodes, img_data=img_data, path=path, distance=distance, fuel_consumed=fuel_consumed)
